...
class ItauShopline(object):
    ...
    def __init__(self, codigo, chave, **extra):
        ...
        self.urls['teste'] = extra.get('teste_url', 'https://shopline.itau.com.br/shopline/emissao_teste.asp')
    ...
    def clean(self):
        ...
        # comentado por que o animal de desenvolveu essa api importou dava pau e nao usa pra nada nessa def
        # só pra reforçar ... .. ANIMAL
    ...
    def make_post_page(self, url):
        return """<HTML>
                ...
                </HTML>""" % {'url':self.urls[url], 'DC':self.dc}
    ...
    def sonda(self, pedido, formato):
        ...
        assert len(self.codigo) == 26, u'Tamanho do codigo da empresa diferente de 26 posições'
        assert len(self.chave) == 16, u'Tamanho da chave da chave diferente de 16 posições'
        assert formato in ("0", "1"), u'Formato inválido - 0 para html e 1 para xml'
...
if __name__ == '__main__':
    ...
    CODIGO_EMPRESA = 'J0090471770001180000012197'
    CHAVE = 'r2cp6uhn7l09wsq3'
